 ...
 */
use DotStore\AdvancedFlatRateShipping;
if ( !class_exists( 'Advanced_Flat_Rate_Shipping_For_WooCommerce_Pro' ) ) {
    ...
    class Advanced_Flat_Rate_Shipping_For_WooCommerce_Pro {
        ...
        public function __construct() {
            ...
            add_action( 'wp_loaded', array($this, 'afrsfw_load_constants') );
        }
         ...
         * @since 4.4.1
         */
        public function afrsfw_load_constants() {
        ...
        private function define_public_hooks() {
            ...
            if ( !empty( $afrsm_force_customer_to_select_sm ) && 'on' === $afrsm_force_customer_to_select_sm ) {
                $this->loader->add_filter(
